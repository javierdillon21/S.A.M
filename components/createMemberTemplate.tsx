...
export default function CreateMemberTemplate() {
  ...
  return (
    <form
      className="grid grid-cols-1 mx-4 gap-y-5 sm:grid-cols-3 sm:grid-rows-2 sm:gap-x-6 sm:w-11/12"
      onSubmit={handleSubmitMiembro(SubmitMiembro)}
    >
      {/* INFORMACIÓN BÁSICA PERSONAL */}
      <div className="flex sm:row-span-2 flex-col h-full justify-around gap-y-5">
      ...
      <div className="flex row-span-2 flex-col h-full justify-around gap-y-5">
        <span className="border-b font-bold text-2xl text-primary-100">
          Información laboral y/o académica
        </span>
        <div className="grid grid-cols-2 gap-x-3 gap-y-1">
